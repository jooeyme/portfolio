import { PROFILE, SKILLS, EDUCATION, EXPERIENCE } from '../../models/portfolioData';
        ...
        <section id={id} className="py-20 px-4 md:px-12 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 mb-20">
                <div className="relative">
                    <div className="aspect-[3/4] rounded-lg overflow-hidden border-2 border-zinc-800 shadow-2xl">
                        <img
